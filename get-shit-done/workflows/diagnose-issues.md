...
```bash
node ~/.claude/get-shit-done/bin/arc-tools.js commit "docs({phase}): add root causes from diagnosis" --files ".planning/phases/XX-name/{phase}-UAT.md"
```
</step>
