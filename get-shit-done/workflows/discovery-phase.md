...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /arc:research-phase instead, which produces RESEARCH.md.
</purpose>
...
1. Discuss phase context (/arc:discuss-phase [current-phase])
2. Create phase plan (/arc:plan-phase [current-phase])
