...
If you've modified any GSD files directly, they'll be automatically backed up to `gsd-local-patches/` and can be reapplied with `/arc:reapply-patches` after the update.
```
...
Run /arc:reapply-patches to merge your modifications into the new version.
```
